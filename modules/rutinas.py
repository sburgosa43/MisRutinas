...
EJERCICIOS_BASE = [
    ...
    {"id":"g01","nombre":"Hip Thrust con barra","grupo":"Glúteos",
     ...
     "url":"https://www.youtube.com/results?search_query=bret+contreras+hip+thrust+tutorial&sp=EgQIAxAB"},
    {"id":"g02","nombre":"Hip Thrust con mancuerna","grupo":"Glúteos",
     ...
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+dumbbell+hip+thrust+tutorial&sp=EgQIAxAB"},
    {"id":"g03","nombre":"Glute Bridge (peso corporal)","grupo":"Glúteos",
     ...
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=bret+contreras+glute+bridge+tutorial&sp=EgQIAxAB"},
    {"id":"g04","nombre":"Bulgarian Split Squat","grupo":"Glúteos",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+bulgarian+split+squat+tutorial&sp=EgQIAxAB"},
    {"id":"g05","nombre":"Donkey Kick","grupo":"Glúteos",
     ...
     "equipo":["ninguno","mat"],"dificultad":"principiante",
     "objetivo":["recomposicion","salud"],"lesiones_evitar":[],
     "coach":"Sydney Cummings","url":"https://www.youtube.com/results?search_query=heather+robertson+donkey+kick+glute+tutorial&sp=EgQIAxAB"},
    {"id":"g06","nombre":"Cable Kickback","grupo":"Glúteos",
     ...
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":[],
     "coach":"Stephanie Sanzo","url":"https://www.youtube.com/results?search_query=bret+contreras+cable+kickback+glutes+tutorial&sp=EgQIAxAB"},
    {"id":"g07","nombre":"Clamshell con banda","grupo":"Glúteos",
     ...
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+clamshell+exercise+band+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"q01","nombre":"Sentadilla con barra","grupo":"Cuádriceps",
     ...
     "coach":"Squat University","url":"https://www.youtube.com/results?search_query=squat+university+barbell+squat+technique+tutorial&sp=EgQIAxAB"},
    {"id":"q02","nombre":"Sentadilla goblet con mancuerna","grupo":"Cuádriceps",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+goblet+squat+tutorial&sp=EgQIAxAB"},
    {"id":"q03","nombre":"Sentadilla sumo","grupo":"Cuádriceps",
     ...
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":[],
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+sumo+squat+tutorial&sp=EgQIAxAB"},
    {"id":"q04","nombre":"Leg Press","grupo":"Cuádriceps",
     ...
     "coach":"Jeremy Ethier","url":"https://www.youtube.com/results?search_query=jeremy+ethier+leg+press+technique+tutorial&sp=EgQIAxAB"},
    {"id":"q05","nombre":"Estocada con mancuernas","grupo":"Cuádriceps",
     ...
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":["Rodillas"],
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+dumbbell+lunge+tutorial&sp=EgQIAxAB"},
    {"id":"q06","nombre":"Step Up con mancuernas","grupo":"Cuádriceps",
     ...
     "objetivo":["recomposicion","salud"],"lesiones_evitar":["Rodillas"],
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+step+up+exercise+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"i01","nombre":"Romanian Deadlift con barra","grupo":"Isquiotibiales",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+romanian+deadlift+barbell+tutorial&sp=EgQIAxAB"},
    {"id":"i02","nombre":"Romanian Deadlift con mancuernas","grupo":"Isquiotibiales",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+dumbbell+romanian+deadlift+tutorial&sp=EgQIAxAB"},
    {"id":"i03","nombre":"Leg Curl en máquina","grupo":"Isquiotibiales",
     ...
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":[],
     "coach":"Jeremy Ethier","url":"https://www.youtube.com/results?search_query=jeremy+ethier+lying+leg+curl+machine+tutorial&sp=EgQIAxAB"},
    {"id":"i04","nombre":"Good Morning con mancuernas","grupo":"Isquiotibiales",
     ...
     "coach":"Alan Thrall","url":"https://www.youtube.com/results?search_query=alan+thrall+good+morning+exercise+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"e01","nombre":"Jalón al pecho (Lat Pulldown)","grupo":"Espalda",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+lat+pulldown+technique+tutorial&sp=EgQIAxAB"},
    {"id":"e02","nombre":"Remo con mancuerna (un brazo)","grupo":"Espalda",
     ...
     "equipo":["mancuernas","banco"],"dificultad":"principiante",
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":[],
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+one+arm+dumbbell+row+tutorial&sp=EgQIAxAB"},
    {"id":"e03","nombre":"Remo con barra","grupo":"Espalda",
     ...
     "equipo":["barra"],"dificultad":"intermedio",
     "objetivo":["recomposicion","hipertrofia","fuerza"],"lesiones_evitar":["Espalda baja (lumbar)"],
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+barbell+row+technique+tutorial&sp=EgQIAxAB"},
    {"id":"e04","nombre":"Face Pull con banda","grupo":"Espalda",
     ...
     "objetivo":["recomposicion","salud","rehabilitacion"],"lesiones_evitar":[],
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+face+pull+band+technique+tutorial&sp=EgQIAxAB"},
    {"id":"e05","nombre":"Superman","grupo":"Espalda",
     ...
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+superman+exercise+back+tutorial&sp=EgQIAxAB"},
    {"id":"e06","nombre":"Dominadas asistidas","grupo":"Espalda",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+pull+up+progression+tutorial+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"p01","nombre":"Press de pecho con mancuernas","grupo":"Pecho",
     ...
     "equipo":["mancuernas","banco"],"dificultad":"principiante",
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":["Espalda alta / hombros"],
     "coach":"Jeremy Ethier","url":"https://www.youtube.com/results?search_query=jeremy+ethier+dumbbell+chest+press+tutorial&sp=EgQIAxAB"},
    {"id":"p02","nombre":"Push-up (flexión de pecho)","grupo":"Pecho",
     ...
     "coach":"Athlean-X","url":"https://www.youtube.com/results?search_query=athlean+x+perfect+push+up+form+tutorial&sp=EgQIAxAB"},
    {"id":"p03","nombre":"Fly con mancuernas","grupo":"Pecho",
     ...
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":["Espalda alta / hombros"],
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+dumbbell+fly+technique+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"h01","nombre":"Press de hombros con mancuernas","grupo":"Hombros",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+dumbbell+shoulder+press+tutorial&sp=EgQIAxAB"},
    {"id":"h02","nombre":"Elevaciones laterales","grupo":"Hombros",
     ...
     "equipo":["mancuernas"],"dificultad":"principiante",
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":["Espalda alta / hombros"],
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+lateral+raise+perfect+form+tutorial&sp=EgQIAxAB"},
    {"id":"h03","nombre":"Elevaciones frontales","grupo":"Hombros",
     ...
     "equipo":["mancuernas"],"dificultad":"principiante",
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":["Espalda alta / hombros"],
     "coach":"Jeremy Ethier","url":"https://www.youtube.com/results?search_query=jeremy+ethier+front+raise+dumbbell+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"b01","nombre":"Curl con mancuernas","grupo":"Bíceps",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+dumbbell+curl+perfect+form+tutorial&sp=EgQIAxAB"},
    {"id":"b02","nombre":"Curl martillo","grupo":"Bíceps",
     ...
     "equipo":["mancuernas"],"dificultad":"principiante",
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":["Muñecas / codos"],
     "coach":"Jeremy Ethier","url":"https://www.youtube.com/results?search_query=jeremy+ethier+hammer+curl+tutorial&sp=EgQIAxAB"},
    {"id":"b03","nombre":"Curl con barra","grupo":"Bíceps",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+barbell+curl+technique+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"t01","nombre":"Extensión de tríceps sobre cabeza","grupo":"Tríceps",
     ...
     "coach":"Jeff Nippard","url":"https://www.youtube.com/results?search_query=jeff+nippard+overhead+tricep+extension+tutorial&sp=EgQIAxAB"},
    {"id":"t02","nombre":"Fondos en banco (Dips)","grupo":"Tríceps",
     ...
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+bench+dips+tricep+tutorial&sp=EgQIAxAB"},
    {"id":"t03","nombre":"Kickback de tríceps","grupo":"Tríceps",
     ...
     "equipo":["mancuernas","banco"],"dificultad":"principiante",
     "objetivo":["recomposicion","hipertrofia"],"lesiones_evitar":["Muñecas / codos"],
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+tricep+kickback+dumbbell+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"c01","nombre":"Plancha (Plank)","grupo":"Core",
     ...
     "coach":"Squat University","url":"https://www.youtube.com/results?search_query=squat+university+plank+perfect+form+tutorial&sp=EgQIAxAB"},
    {"id":"c02","nombre":"Dead Bug","grupo":"Core",
     ...
     "coach":"Squat University","url":"https://www.youtube.com/results?search_query=squat+university+dead+bug+exercise+core+tutorial&sp=EgQIAxAB"},
    {"id":"c03","nombre":"Bird Dog","grupo":"Core",
     ...
     "equipo":["ninguno","mat"],"dificultad":"principiante",
     "objetivo":["recomposicion","salud","rehabilitacion"],"lesiones_evitar":[],
     "coach":"Squat University","url":"https://www.youtube.com/results?search_query=squat+university+bird+dog+exercise+tutorial&sp=EgQIAxAB"},
    {"id":"c04","nombre":"Mountain Climber","grupo":"Core",
     ...
     "coach":"Sydney Cummings","url":"https://www.youtube.com/results?search_query=sydney+cummings+mountain+climber+cardio+tutorial&sp=EgQIAxAB"},
    {"id":"c05","nombre":"Crunch abdominal","grupo":"Core",
     ...
     "coach":"Heather Robertson","url":"https://www.youtube.com/results?search_query=heather+robertson+ab+crunch+proper+form+tutorial&sp=EgQIAxAB"},
    ...
    {"id":"ca01","nombre":"Bicicleta estática — Steady State","grupo":"Cardio",
     ...
     "coach":"","url":"https://www.youtube.com/results?search_query=+zone+2+cardio+stationary+bike+benefits+tutorial&sp=EgQIAxAB"},
    {"id":"ca02","nombre":"Bicicleta estática — HIIT","grupo":"Cardio",
     ...
     "coach":"","url":"https://www.youtube.com/results?search_query=sydney+cummings+stationary+bike+HIIT+workout+tutorial&sp=EgQIAxAB"},
    {"id":"ca03","nombre":"Jump Squat","grupo":"Cardio",
     ...
     "coach":"Sydney Cummings","url":"https://www.youtube.com/results?search_query=sydney+cummings+jump+squat+explosive+tutorial&sp=EgQIAxAB"},
    {"id":"ca04","nombre":"Burpee","grupo":"Cardio",
     ...
     "coach":"Sydney Cummings","url":"https://www.youtube.com/results?search_query=sydney+cummings+burpee+proper+form+tutorial&sp=EgQIAxAB"},
]
